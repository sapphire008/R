...
# Linear Models
lm.v1.c.disp        = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.V1.C)
lm.v1.sz.disp       = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.V1.SZ)
lm.v1.c.speed       = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.V1.C)
lm.v1.sz.speed      = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.V1.SZ)
lm.v1.c.disp_speed  = lm(GABA.Cr ~ RMS_Mag_disp+I(RMS_Mag_speed*5), no_outlier_subject_data.V1.C)
lm.v1.sz.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp+I(RMS_Mag_speed*5), no_outlier_subject_data.V1.SZ)
lm.v1.c_sz.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp + I(RMS_Mag_speed*5) + Groups, no_outlier_subject_data.V1.All)

lm.mfg.c.disp        = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.MFG.C)
lm.mfg.sz.disp       = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.MFG.SZ)
lm.mfg.c.speed       = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.MFG.C)
lm.mfg.sz.speed      = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.MFG.SZ)
lm.mfg.c.disp_speed  = lm(GABA.Cr ~ RMS_Mag_disp+I(RMS_Mag_speed*5), no_outlier_subject_data.MFG.C)
lm.mfg.sz.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp+I(RMS_Mag_speed*5), no_outlier_subject_data.MFG.SZ)
lm.mfg.c_sz.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp + I(RMS_Mag_speed*5) + Groups, no_outlier_subject_data.MFG.All)
...
# controls
p = ggplot(no_outlier_subject_data.MFG.C, aes(x=RMS_Mag_disp, y=GABA.Cr)) +
  geom_point(shape=1,size=6) +
  geom_smooth(method=lm)+
  xlab(expression("RMS of Displacemet " * Delta ~ " (mm)"))+
  ylab("MFG GABA/Cr")
L = as.character(as.expression(R^2 ~"=" ~ -0.005793))
...
p = ggplot(no_outlier_subject_data.MFG.C, aes(x=RMS_Mag_speed*5, y=GABA.Cr)) +
  geom_point(shape=1,size=6) +
  geom_smooth(method=lm)+
  xlab(expression("RMS of Speed " * Sigma ~ " (mm/s)"))+
  ylab("MFG GABA/Cr")
L = as.character(as.expression(R^2 ~"=" ~ -0.03274))
p + geom_text(aes(x=0.1,y = 0.17, label = L),size=6,parse=T)+
  theme(axis.text.x = element_text(size=18),axis.title.x = element_text(size=20),
        axis.text.y = element_text(size=18),axis.title.y = element_text(size=20))


# patients
p = ggplot(no_outlier_subject_data.MFG.SZ, aes(x=RMS_Mag_disp, y=GABA.Cr)) +
  geom_point(shape=1,size=6) +
  geom_smooth(method=lm)+
  xlab(expression("RMS of Displacemet " * Delta ~ " (mm)"))+
  ylab("MFG GABA/Cr")
L = as.character(as.expression(R^2 ~"=" ~ -0.04967 ))
p + geom_text(aes(x=2.0,y = 0.16, label = L),size=6,parse=T)+
  theme(axis.text.x = element_text(size=18),axis.title.x = element_text(size=20),
        axis.text.y = element_text(size=18),axis.title.y = element_text(size=20))
...
p = ggplot(no_outlier_subject_data.V1.SZ, aes(x=RMS_Mag_speed*5, y=GABA.Cr)) +
  ...
  xlab(expression("RMS of Speed " * Sigma ~ " (mm/s)"))+
  ylab("MFG GABA/Cr")
L = as.character(as.expression(R^2 ~"=" ~  -0.04987))
...
# RMS_Mag_disp
d = data.frame(x=gl(1,length(data.MFG.SZ$RMS_Mag_disp)),y=data.MFG.SZ$RMS_Mag_disp)
...
# RMS_Mag_speed
d = data.frame(x=gl(1,length(data.MFG.SZ$RMS_Mag_speed)),y=5*data.MFG.SZ$RMS_Mag_speed)
p = ggplot(d,aes(x,y))+geom_violin(fill="skyblue", alpha=0.5) + coord_flip()
p = p + stat_summary(fun.data= f1, geom="boxplot",alpha=0.5) #boxplot
p = p + stat_summary(fun.y=f2, geom="point",size = 4)# outlier
...
# GABA/Cr
d = data.frame(x=gl(1,length(data.MFG.SZ$GABA.Cr)),y=data.MFG.SZ$GABA.Cr)
p = ggplot(d,aes(x,y))+geom_violin(fill="skyblue", alpha=0.5) + coord_flip()
...
#lm.v1.c.disp = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.V1.C) # control disp
ggplot(lm.mfg.c.disp, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
...
#lm.v1.c.speed = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.V1.C) # control speed
ggplot(lm.mfg.c.speed, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
  geom_point(shape=1,size=5) + geom_smooth(se = F,method = loess) + scale_x_continuous("Fitted Values") +
...
#lm.v1.c.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp + I(RMS_Mag_speed*5), no_outlier_subject_data.V1.C)
ggplot(lm.mfg.c.disp_speed, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
  geom_point(shape=1,size=5) + geom_smooth(se = F,method = loess) + scale_x_continuous("Fitted Values") +
...
#=========================================================================================================================
#lm.v1.sz.disp = lm(GABA.Cr ~ RMS_Mag_disp, no_outlier_subject_data.V1.SZ) #patient disp
ggplot(lm.mfg.sz.disp, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
  geom_point(shape=1,size=5) + geom_smooth(se = F,method = loess) + scale_x_continuous("Fitted Values") +
...
#lm.v1.sz.speed = lm(GABA.Cr ~ I(RMS_Mag_speed*5), no_outlier_subject_data.V1.SZ) # patient speed
ggplot(lm.mfg.sz.speed, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
  geom_point(shape=1,size=5) + geom_smooth(se = F,method = loess) + scale_x_continuous("Fitted Values") +
...
#lm.v1.sz.disp_speed = lm(GABA.Cr ~ RMS_Mag_disp + I(RMS_Mag_speed*5), no_outlier_subject_data.V1.SZ)
ggplot(lm.mfg.sz.disp_speed, aes(.fitted, .resid)) + geom_hline(linetype = 2, size = 0.2) +
  geom_point(shape=1,size=5) + geom_smooth(se = F,method = loess) + scale_x_continuous("Fitted Values") +
